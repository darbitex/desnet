# DeSNet v0.3.0 mainnet baseline — Full Source for External Audit

**Companion to `AUDIT-DESNET-V030-SUBMISSION.md`.** Complete Move source for the 17 modules of the v0.3.0 monolith package — the source that gets published to mainnet at step 1 (before any compat upgrade).

**Total:** 17 Move files, ~7434 LoC, all compile clean. 68/68 unit + integration tests pass.

**Module index:**

Orchestration (3): governance, factory, profile
AMM + staking (2): amm, lp_staking
Verbs (4): mint, pulse, press, link
Storage (2): history, assets
Economics (3): apt_vault, lp_emission, reaction_emission
Social/gating (3): reference_gate, giveaway, voter_history

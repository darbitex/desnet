...
module desnet::profile {
    ...
    const PRICE_1_CHAR_SUPRA: u64 = 10_000_000_000;     // 100 SUPRA
    const PRICE_2_CHAR_SUPRA: u64 =  5_000_000_000;     //  50 SUPRA
    const PRICE_3_CHAR_SUPRA: u64 =  2_000_000_000;     //  20 SUPRA
    const PRICE_4_CHAR_SUPRA: u64 =  1_000_000_000;     //  10 SUPRA
    const PRICE_5_CHAR_SUPRA: u64 =    500_000_000;     //   5 SUPRA
    const PRICE_6PLUS_CHAR_SUPRA: u64 = 100_000_000;    //   1 SUPRA
    ...
    public entry fun register_handle(
        ...
        //    Plus pool_seed_supra (5 SUPRA) — withdrawn as separate FA, passed to factory
        ...
        let pool_seed_amount = factory::pool_seed_supra_amount();
        let pool_seed_fa = primary_fungible_store::withdraw(wallet, supra_metadata, pool_seed_amount);
        ...
        //    so SUPRA collection above cannot be bypassed by external callers.
